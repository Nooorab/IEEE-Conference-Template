...
\begin{abstract}
PDF files are the dominant format for public communication among Swedish government agencies. Beyond their visible content, PDF files contain embedded metadata---including author names, usernames, software environments, and traces of internal workflows---that can be extracted with minimal effort. This study analyses metadata and hidden version history in publicly available PDF documents from 30 Swedish public-sector organisations, assessing unintended information exposure and its implications for cybersecurity.
\end{abstract}
...
\clearpage % This forces the references to start on a new page
